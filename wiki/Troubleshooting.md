...
**Solutions**:
1. Check (`questions.md`)[/questions.md] for the problem number
2. Use the naming convention: Check (Problem Index)[/questions.md] for filenames.
3. Check the interactive (`index.html`)[dibyajyotibiswal57.github.io/programs] status page
...
**Solutions**:
- Follow naming convention: Check (Problem index)[/questions.md]
