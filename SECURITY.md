...
## Supported Versions
Only the latest versions of the programs in the `main` branch are actively maintained.
...
This repository is for educational programs only. Any contribution containing code designed to harm a system (ransomware, spyware, etc.) will be rejected and reported.
