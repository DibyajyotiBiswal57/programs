...
39. Read two numbers. If both numbers are even then display their sum else display their difference.
...
Sum: 40
```
89. Write a program to check whether a number is a perfect number.
